...
import com.edu.sondong.repository.SubjectRepository;
import com.edu.sondong.service.dto.SubjectDTO;
import com.edu.sondong.service.mapper.SubjectMapper;
...
public class SubjectResourceIntTest {
    ...
    public void setup() {
        ...
        final SubjectResource subjectResource = new SubjectResource(subjectRepository, subjectMapper);
    ...
    public void createSubject() throws Exception {
        ...
        assertThat(testSubject.getTotalHours()).isEqualTo(DEFAULT_TOTAL_HOURS);
    }
    ...
    public void updateSubject() throws Exception {
        ...
        assertThat(testSubject.getTotalHours()).isEqualTo(UPDATED_TOTAL_HOURS);
    }
