...
import com.edu.sondong.repository.SemesterRepository;
...
import com.edu.sondong.service.mapper.SemesterMapper;
...
public class SemesterResource {
    ...
    @Timed
    public ResponseEntity<SemesterDTO> updateSemester(@RequestBody SemesterDTO semesterDTO) throws URISyntaxException {
