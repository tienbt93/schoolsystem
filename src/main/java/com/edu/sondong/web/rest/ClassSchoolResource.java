...
import com.edu.sondong.repository.ClassSchoolRepository;
...
import com.edu.sondong.service.mapper.ClassSchoolMapper;
...
public class ClassSchoolResource {
    ...
    @Timed
    public ResponseEntity<ClassSchoolDTO> createClassSchool(@RequestBody ClassSchoolDTO classSchoolDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<ClassSchoolDTO> updateClassSchool(@RequestBody ClassSchoolDTO classSchoolDTO) throws URISyntaxException {
